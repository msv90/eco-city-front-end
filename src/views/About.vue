  ...
  <div class="container">
    ...
    <main class="content">
      <div class="content_spacer">
        ...
        <div class="text_wrap seo_text" v-html="aboutData"></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            Api.page.getByCode("about").then(response => {
                if (response.status === 200)
                    this.aboutData = response.data.data;
            })

            Api.section.getByCode('obshhaya-informatsiya').then(response => {
                if(response.status === 200){
                    if('obshhaya-informatsiya' in response.data) {
                        this.title = response.data['obshhaya-informatsiya'].title
                        this.seoTitle = response.data['obshhaya-informatsiya'].seo_title
                        this.seoDescription = response.data['obshhaya-informatsiya'].seo_description
                        this.seoKeywords = response.data['obshhaya-informatsiya'].seo_keywords
